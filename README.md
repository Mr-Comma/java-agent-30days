...
```json
{
  ...
  "workflowStatusAllowedValues": ["READY", "NEEDS_INPUT"],
  "workflowStageAllowedValues": ["REVIEW_READY", "INPUT_REQUIRED"],
  "suggestedToolAllowedValues": ["api-risk-reviewer", "openapi-input-validator"],
  "nextActionCodeAllowedValues": [
